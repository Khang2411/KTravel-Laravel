                        ...
                        <tr v-for="(category, index) in categories.data" :key="index"
                            ...
                            <th scope="row">
                                <div
                                    ...
                                    <img class="w-12 h-12 dark:bg-white" :src="category.icon" alt="img-category">
                                    <div class="ps-3">
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative w-full max-w-2xl max-h-full">
                        <form @submit.prevent="submit" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-10">
                                <div class="mb-5">
                                    <InputLabel for="name" value="Tên thể loại" class="dark:text-white" />
                                    <TextInput type="text"
                                ...
                                <div class="mt-5">
                                    <InputLabel for="icon" value="Chọn icon thể loại"
                                        class="cursor-pointer dark:text-white" />
                                    <input type="file" id="icon" @input="form.icon = $event.target.files[0]"
                                        class="hidden" @change="handleChangeThumbnail" />
                                    <InputError class="mt-2" :message="form.errors.icon" />
                                    <img v-if="!previewIconUrl && form.icon" :src="form.icon" class="w-16 mt-4 h-16 " />
                                    <img v-if="previewIconUrl" :src="previewIconUrl" class="w-16 mt-4 h-16" />
                                </div>
                            </div>
